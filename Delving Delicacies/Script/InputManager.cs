...
public class InputManager : MonoBehaviour
{
    ...
    public static bool mouseContinuous = false;
    ...
    void Update()
    {
        ...
        pressEsq = Input.GetKeyDown(KeyCode.Escape);
        isMousePressed = Input.GetKeyDown(KeyCode.Mouse0);
        mouseContinuous = Input.GetKey(KeyCode.Mouse0);
