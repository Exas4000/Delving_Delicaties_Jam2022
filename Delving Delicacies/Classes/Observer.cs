...
public class Observer : MonoBehaviour
{
    ...
    public void ScoreEvent(float score)
    {
        foreach (Subscriber sub in subcriberList)
        {
            sub.OnScoreEvent(score);
        }
    }

    public void PlayerHealthChange(int currentPlayerHp)
    {
        foreach (Subscriber sub in subcriberList)
        {
            sub.OnHealthChangeEvent(currentPlayerHp);
        }
    }
    ...
    public void MilestoneEvent()
    {
        foreach (Subscriber sub in subcriberList)
        {
            sub.OnMilestoneChange();
        }
    }
